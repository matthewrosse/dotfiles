...
static const char *const autostart[] = {
    "picom", NULL,        "nitrogen", "--restore", NULL,  "volumeicon",
    NULL,    "xset",      "r",        "rate",      "200", "30",
    NULL,    "dwmblocks", NULL,       NULL /* terminate */
};
...
static const char *dmconfcmd[] = {"/home/matthewrose/.scripts/dmconf", NULL};
static const char *nvimcmd[] = {"st", "-e", "nvim", NULL};
static const char *bravecdm[] = {"brave", NULL};
 ...
 */
    ...
    {MODKEY, XK_p, spawn, {.v = vifmcmd}},
    {MODKEY | ShiftMask, XK_e, spawn, {.v = dmconfcmd}},
    {MODKEY | ShiftMask, XK_p, spawn, {.v = nvimcmd}},
    {MODKEY | ShiftMask, XK_w, spawn, {.v = bravecdm}},
#if RIODRAW_PATCH
